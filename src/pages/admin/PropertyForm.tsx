    ...
    <div className="max-w-3xl mx-auto space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <Tabs defaultValue="info" className="space-y-4">
          ...
          <TabsContent value="info" forceMount className={cn('data-[state=inactive]:hidden mt-0')}>
            <Card>
          ...
          <TabsContent value="valores" forceMount className={cn('data-[state=inactive]:hidden mt-0')}>
            <Card>
          ...
          <TabsContent value="local" forceMount className={cn('data-[state=inactive]:hidden mt-0')}>
            <Card>
          ...
          <TabsContent value="detalhes" forceMount className={cn('data-[state=inactive]:hidden mt-0')}>
            <Card>
          ...
          <TabsContent value="fotos" forceMount className={cn('data-[state=inactive]:hidden mt-0')}>
            <PropertyImageUpload
              images={form.images}
